...
const CollegeAdmissionForm = () => {
  ...
  return (
    <>
    <Navbar/>
    <div className="relative top-17 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-6 px-4">
            ...
            {activeTab === "academic" && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">Previous Qualification Percentage/CGPA *</label>
                      <input
                        type="text"
                        name="marks"
            ...
            {activeTab === "submission" && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {/* <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">Upload submission</label>
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-all duration-200 bg-gray-50 hover:bg-blue-50">
                        ...
                        <p className="text-xs text-gray-500 mt-2">PDF, DOC, DOCX, JPG, JPEG, PNG (max. 10MB)</p>
                        {formData.submission && (
                          <div className="mt-3 p-2 bg-green-100 rounded-lg">
                            <p className="text-sm text-green-700">✓ {formData.submission.name}</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-lg border border-gray-200">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      {/* <div className="flex justify-between">
                        ...
                        <span className="font-medium">{formData.submission ? "✓ Uploaded" : "Not uploaded"}</span>
                      </div> */}
                    </div>
                  </div>
                </div>
